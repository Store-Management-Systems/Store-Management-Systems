...
const recordPayment = async (req, res) => {
    ...
    try {
        ...
        // Determine transaction direction if not provided:
        // Supplier -> 'out' (Payout made to supplier)
        // Customer / Party -> 'in' (Collection received from customer/party)
        ...
        // If Payment In (Collection from Customer/Party) -> Credit entity ledger (reduces receivable)
        // If Payment Out (Payout to Supplier) -> Debit entity ledger (reduces payable)
        ...
        // Recalculate dynamic due balance
        let updatedDue = 0;
