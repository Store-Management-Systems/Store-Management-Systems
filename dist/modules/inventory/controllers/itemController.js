...
const createItem = async (req, res) => {
    ...
    try {
        ...
        await db.prepare(`
            ...
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(itemId, activeShop, name, category, unit, buyPriceNum, sellingPriceNum, sellingPriceNum, stockNum, stockNum, 'active');
        let warning = null;
...
const updateItem = async (req, res) => {
    ...
    try {
        ...
        `).run(name, category, unit, newBuyPrice, newSellingPrice, newSellingPrice, newStock, newStock, id, activeShop);
        let warning = null;
